...
(Mostly in class work with creating an example)
---
**Parsing with Bison**
***
...
```
(From the SubsetC project, https://github.com/kranthikiran01/subc-compiler).
---
Or:
...
#endif /* RIPPER */
```
This is Ruby (from https://github.com/ruby)
---
